...
public class f0
{
  ...
  public static int c(Context paramContext, int paramInt)
  {
    ...
    paramContext = k0.u(paramContext, null, arrayOfInt);
    try
    {
  ...
  static int d(Context paramContext, int paramInt, float paramFloat)
  {
    ...
    return a.o(paramInt, Math.round(Color.alpha(paramInt) * paramFloat));
  }
  ...
  public static ColorStateList e(Context paramContext, int paramInt)
  {
    ...
    paramContext = k0.u(paramContext, null, (int[])localObject1);
    try
    {
