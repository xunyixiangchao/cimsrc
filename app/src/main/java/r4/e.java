  ...
  implements View.OnClickListener, DialogInterface.OnShowListener
{
  ...
  public e(Context paramContext)
  {
    ...
    ((TextView)findViewById(2131231396)).setText(2131689526);
    EditText localEditText = (EditText)findViewById(2131231090);
    this.d = localEditText;
    localEditText.setHint(Html.fromHtml(paramContext.getString(2131689596)));
  ...
  {
    ((TextView)findViewById(2131231396)).setText(paramInt);
  }
  ...
  public void show()
  {
    ((WebImageView)findViewById(2131231150)).setImageResource(2131165467);
    super.show();
    this.d.requestFocus();
  }
}
