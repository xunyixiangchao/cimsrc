  ...
  implements Parcelable
{
  ...
  {
    public ParcelableSparseArray a(Parcel paramParcel)
    {
      return new ParcelableSparseArray(paramParcel, null);
    }
    
    public ParcelableSparseArray b(Parcel paramParcel, ClassLoader paramClassLoader)
    {
      return new ParcelableSparseArray(paramParcel, paramClassLoader);
    }
    
    public ParcelableSparseArray[] c(int paramInt)
    {
