...
import com.baidu.mapsdkplatform.comapi.animation.a;

public class AlphaAnimation
  extends Animation
{
  public AlphaAnimation(float... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length != 0))
    {
      this.bdAnimation = new a(paramVarArgs);
      return;
    }
 ...
 * Qualified Name:     com.baidu.mapapi.animation.AlphaAnimation
