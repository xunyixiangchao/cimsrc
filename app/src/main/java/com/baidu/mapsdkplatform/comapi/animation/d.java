  ...
  extends BDAnimation
{
  ...
  {
    paramMarker = ObjectAnimator.ofFloat(paramMarker, "scale", this.g);
    if (paramMarker != null)
    {
 ...
 * Qualified Name:     com.baidu.mapsdkplatform.comapi.animation.d
