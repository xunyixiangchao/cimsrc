  ...
  extends BDAnimation
{
  ...
  {
    paramMarker = ObjectAnimator.ofFloat(paramMarker, "alpha", this.g);
    if (paramMarker != null)
    {
 ...
 * Qualified Name:     com.baidu.mapsdkplatform.comapi.animation.a
