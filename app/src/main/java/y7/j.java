  ...
  extends v<Date>
{
  ...
  public Date e(b8.a parama)
  {
    ...
    //   23: dup
    //   24: aload_0
    //   25: getfield 29	y7/j:a	Ljava/text/DateFormat;
    //   28: aload_1
    ...
    //   38: invokespecial 78	java/sql/Date:<init>	(J)V
    //   41: astore_1
    //   42: aload_0
    //   43: monitorexit
    //   44: aload_1
  ...
  public void f(c paramc, Date paramDate)
  {
    if (paramDate == null) {
      paramDate = null;
    }
    try
    {
      paramDate = this.a.format(paramDate);
      paramc.x0(paramDate);
      return;
    }
    finally {}
